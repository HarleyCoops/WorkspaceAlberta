...
Start by telling the AI assistant about the business problem you want to solve. Be specific about:
- What's frustrating you
- What information you need
- What outcome you want

**Example:**
> "I need to see which customers haven't been contacted in 30 days, pulling from my Google Contacts and comparing against my recent Stripe transactions."
...
|------|--------|--------------|
| Filesystem | Ready | Read and write files in your workspace |
| GitHub | Needs `GITHUB_TOKEN` | Access repositories and issues |

*Additional tools will be listed here based on your selection.*
...
4. **Integration Building**
   > "Connect my Stripe payments to my Google Sheets for tracking"
...
- **Your Problem**: Check `problems/` for your business problem description
