# WorkspaceAlberta - AI Business Workspace
...
Click the button below to open this workspace in a cloud-based development environment:
...
See `problems/` folder for the specific problem this workspace was created to solve.
